...
class _InstructionsScreenState extends State<InstructionsScreen> {
  ...
  String _getTranslatedDescription(int index) {
    final Map<String, List<String>> translations = {
      'en': ['Get to know about Rice', 'Optimal Conditions', 'Prep & Planting', 'Best Fertilization', 'Protection & Irrigation', 'End of Cycle'],
      'hi': ['धान के बारे में जानें', 'इष्टतम स्थितियाँ', 'तैयारी और बुवाई', 'सर्वोत्तम उर्वरक', 'सुरक्षा और सिंचाई', 'चक्र का अंत'],
      'pa': ['ਝੋਨਾ ਬਾਰੇ ਜਾਣੋ', 'ਅਨੁਕੂਲ ਹਾਲਾਤ', 'ਤਿਆਰੀ ਅਤੇ ਬਿਜਾਈ', 'ਸਭ ਤੋਂ ਵਧੀਆ ਖਾਦ', 'ਸੁਰੱਖਿਆ ਅਤੇ ਸਿੰਚਾਈ', 'ਚੱਕਰ ਦਾ ਅੰਤ'],
      'ta': ['நெல் பற்றி தெரிந்து கொள்ளுங்கள்', 'சிறந்த நிலைமைகள்', 'தயாரிப்பு மற்றும் நடவு', 'சிறந்த உரமிடுதல்', 'பாதுகாப்பு மற்றும் பாசனம்', 'சுழற்சியின் முடிவு'],
      'te': ['వరి గురించి తెలుసుకోండి', 'అనుకూల పరిస్థితులు', 'తయారీ & నాటడం', 'ఉత్తమ ఎరువులు', 'రక్షణ & నీటి పారుదల', 'పంట ముగింపు'],
      'kn': ['ಭತ್ತ ಬಗ್ಗೆ ತಿಳಿಯಿರಿ', 'ಸೂಕ್ತ ಪರಿಸ್ಥಿತಿಗಳು', 'ತಯಾರಿ ಮತ್ತು ಬಿತ್ತನೆ', 'ಅತ್ಯುತ್ತม ಗೊಬ್ಬರ', 'ರಕ್ಷಣೆ ಮತ್ತು ನೀರಾವರಿ', 'ಚಕ್ರದ ಅಂತ್ಯ'],
      'mr': ['भाताबद्दल जाणून घ्या', 'इष्टतम परिस्थिती', 'तयारी आणि लागवड', 'सर्वोत्तम खत', 'संरक्षण आणि सिंचन', 'चक्राचा शेवट'],
      'gu': ['ડાંગર વિશે જાણો', 'અનુકૂળ પરિસ્થિતિઓ', 'તૈયારી અને વાવણી', 'શ્રેષ્ઠ ખાતર', 'રક્ષણ અને સિંચાઈ', 'ચક્રનો અંત'],
      'bn': ['ধান সম্পর্কে জানুন', 'অনুকূল পরিস্থিতি', 'প্রস্তুতি ও বপন', 'সেরা সার প্রয়োগ', 'সুরক্ষা ও সেচ', 'চক্রের শেষ'],
      'ml': ['നെല്ലിനെക്കുറിച്ച് അറിയുക', 'അഭികാമ്യമായ സാഹചര്യങ്ങൾ', 'തയ്യാറെടുപ്പും വിതയ്ക്കലും', 'മികച്ച വളപ്രയോഗം', 'സംരക്ഷണവും ജലസേചനവും', 'ചക്രത്തിന്റെ അവസാനം'],
      'ur': ['دھان کے بارے میں جانیں', 'بہترین حالات', 'تیاری اور بوائی', 'بہترین فرٹلائزیشن', 'تحفظ اور آب پاشی', 'سائیکل کا اختتام'],
    };
    final list = translations[_currentLocale] ?? translations['en']!;
    return (index >= 0 && index < list.length) ? list[index] : list[0];
  }
