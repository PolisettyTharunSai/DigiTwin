...
class Step1Content extends StatelessWidget {
  ...
  String _t(String key) {
    return Step1Translations.data[locale]?[key] ??
        Step1Translations.data['en']![key]!; // Fallback to English
  }
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Table(
          ...
          children: [
            _buildNutrientRow(_t('nut_carb'), "17.5 g"),
            _buildNutrientRow(_t('nut_vitc'), "19.7 mg"),
            _buildNutrientRow(_t('nut_potas'), "421 mg"),
            _buildNutrientRow(_t('nut_protein'), "2.0 g"),
            _buildNutrientRow(_t('nut_iron'), "0.8 mg"),
            _buildNutrientRow(_t('nut_calc'), "12 mg"),
            _buildNutrientRow(_t('nut_vitb6'), "0.3 mg"),
          ],
        ),
      ),
    );
